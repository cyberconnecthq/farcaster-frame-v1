...
These questions can cover aspects like clothing, hats, eyes, skin color, gender, personality, wealth status, and more. Once the questions are answered, you will collect all appearance, and summarize the giraffe’s transformed image and return it to the user.
`;
